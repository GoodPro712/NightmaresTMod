...
namespace NightmaresTMod.Weapons.Melee
{
	public class CelestiumBlade : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			item.autoReuse = true;
			item.scale = 2f;
			item.shoot = ModContent.ProjectileType<CelestiumBladeProjectile>();
			item.shootSpeed = 30f;
		}
		...
		public override void MeleeEffects(Player player, Rectangle hitbox)
		{
			...
			{
				Dust.NewDustDirect(new Vector2(hitbox.X, hitbox.Y), hitbox.Width, hitbox.Height, ModContent.DustType<NightmariumDust>());
			}
		}
